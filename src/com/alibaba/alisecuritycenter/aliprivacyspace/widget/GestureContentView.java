package com.alibaba.alisecuritycenter.aliprivacyspace.widget;
...
import com.alibaba.alisecuritycenter.aliprivacyspace.common.AppUtil;
import com.alibaba.alisecuritycenter.aliprivacyspace.entity.GesturePoint;
...
public class GestureContentView extends ViewGroup {
	 ...
	 */
	public GestureContentView(Context context, boolean isVerify, String dbMD5PassWord, GestureCallBack callBack) {
		super(context);
		...
		addChild();
		// 初始化一个可以画线的view
		gestureDrawline = new GestureDrawline(context, list, isVerify, dbMD5PassWord, callBack);
	}
